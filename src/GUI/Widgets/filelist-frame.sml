...
struct
  ...
  fun create () =
    ...
    in mkframe [ Frame ( frame_id,
			 [ newButton [ Text "   Reload   ",
				       Command Filelist.reloadOldFiles ],
			   newButton [ Text "   Add File   ",
				       Command ASM_GUI_Actions.addFileDialog ],
			   newButton [ Text "   Insert File   ",
				       Command ASM_GUI_Actions.insertFileDialog ],
			   newButton [ Text "   Remove File   ",
				       Command ASM_GUI_Actions.removeFileDialog ] ],
			 [ Side Right, Fill Y ], [], [] ),
		 Listbox.create () ]
    end
